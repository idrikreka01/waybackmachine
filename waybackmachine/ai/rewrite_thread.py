...
def _build_prompt(thread_payload: dict[str, Any]) -> str:
    instructions = (
        ...
        "- Do not add a 'User Responses' section.\n"
        "- Do not write username-by-username bullets or lists (example: 'username: said ...').\n"
        "- Summarize community reactions in aggregate prose without naming individual users unless absolutely required for accuracy.\n"
        ...
        "  7) Community sentiment summary (aggregated, no username list)\n"
        "\n"
        "RULES FOR evidence:\n"
...
def _build_finalizer_prompt(thread_payload: dict[str, Any], rewrite: dict[str, Any]) -> str:
    instructions = (
        ...
        "- Do not add a 'User Responses' section.\n"
        "- Do not write username-by-username bullets or lists.\n"
        "- Summarize community reactions in aggregate prose without naming individual users unless absolutely required for accuracy.\n"
