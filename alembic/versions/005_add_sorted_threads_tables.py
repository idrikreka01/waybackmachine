"""Add main_categories, main_category_rules, thread_sorted for keyword-based sorting.
...
def downgrade() -> None:
    op.drop_index("ix_thread_sorted_main_category_id", table_name="thread_sorted")
    op.drop_index("ix_main_category_rules_main_category_id", table_name="main_category_rules")
    op.drop_table("thread_sorted")
    op.drop_table("main_category_rules")
